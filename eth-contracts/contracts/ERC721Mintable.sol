...
contract Ownable {
    ...
    constructor() public {
        _owner = msg.sender;
        emit transferOfOwnership(msg.sender);
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(_tokenOwner[tokenId] != to, "Recipient is already owner of token");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == getOwner() || isApprovedForAll(_tokenOwner[tokenId], msg.sender), "sender must own contract or approval for all must be true");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        if (_exists(tokenId) || to == address(0)) {
            revert("TxRevert - tokenId already exists or address is invalid");
        }
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "from address must own token");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function getBaseTokenURI() view external returns (string memory) {
...
contract PropertyTitleERC721Token is ERC721Metadata {

    constructor() public ERC721Metadata("PropertyTitle", "PYT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {}
